...
function library:SendNotification(duration, message)
	...
	if LastNotification < 0.2 or not library.base then
		return
	end
	LastNotification = 0
	if duration then
	...
	if syn then
		library:Create("Frame", {
			...
			BackgroundColor3 = Color3.fromRGB(199, 255, 255),
			BorderSizePixel = 0,
			Parent = notification
		...
		tweenService:Create(library:Create("TextLabel", {
			...
			TextColor3 = Color3.fromRGB(199, 255, 255),
			TextSize = 16,
			TextTransparency = 1,
			Parent = notification
...
Loaded, LoadError = pcall(function()
	...
	if GameTitle == "Criminality" then
		...
		KillAuraWait = false
		KillAuraMode = "Legit"
		KillAuraTargetPart = "Random"
		FinishAuraMode = "Legit"
		FinishAuraTargetPart = "Random"
		SafeAutoFarm = false
				...
				if type(v) == 'table' and rawget(v, 'EquipTime') then
					if library and library.flags[GameTitle .. " Recoil"] then
						coroutine.resume(coroutine.create(function()
							...
							if library.flags[GameTitle .. " No Camera Recoil"] then
					...
					if library and library.flags[GameTitle .. " Equip Time"] then
						coroutine.resume(coroutine.create(function()
							...
							if library.flags[GameTitle .. " No Equip Animation"] then
					...
					if library and library.flags[GameTitle .. " Aim Speed"] then
						coroutine.resume(coroutine.create(function()
							...
							if library.flags[GameTitle .. " No Aim Animation"] then
		...
		function GetDealer(Studs, Type)
			...
			for _, v in ipairs(game:GetService("Workspace").Map.Shopz:GetChildren()) do
				if SafeAutoFarm then
					if library.flags.AutoFarmMode == "Crowbar" then
		...
		function Teleport(Position)
			if library.flags.TeleportationMode == "Normal" then
				game:GetService("Players").LocalPlayer.Character.Humanoid:UnequipTools()
				local SelfCharacter = game:GetService("Players").LocalPlayer.Character
				...
				wait(0.1)
				SelfRootPart.Position = Vector3.new(0, - 9e9, 0)
				wait(0.5)
				ScreenGui:Destroy()
				if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Crowbar") then
				...
				elseif game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Lockpick") then
				...
				SelfRootPart.Position = Position + Vector3.new(0, 250, 0)
				wait(0.1)
				SelfRootPart.Position = Vector3.new(0, - 9e9, 0)
				wait(1)
				library:AddConnection(runService.RenderStepped, "Teleporation", function()
					SelfRootPart.Position = Position + Vector3.new(0, 250, 0)
				end)
				wait(3)
				library.connections["Teleporation"]:Disconnect()
				SelfRootPart.Position = Position
			end
		end
		...
		LegitGunModules:AddToggle({
			...
			callback = function(State)
				if library.flags[GameTitle .. " Recoil"] then
					GunModules()
				end
			end
		})
		...
		LegitGunModules:AddToggle({
			...
			max = 15,
			callback = function(State)
				if library.flags[GameTitle .. " Spread"] then
					GunModules()
				end
			end
		})
		...
		LegitGunModules:AddToggle({
			...
			max = 15,
			callback = function(State)
				if library.flags[GameTitle .. " Drop Off"] then
					GunModules()
				end
			end
		})
		...
		LegitGunModules:AddSlider({
			...
			max = 15,
			callback = function(State)
				if library.flags[GameTitle .. " Equip Time"] then
					GunModules()
				end
			end
		})
		...
		LegitGunModules:AddToggle({
			...
			callback = function(State)
				if library.flags[GameTitle .. " Aim Speed"] then
					GunModules()
				end
			end
		})
		...
		LegitGunModules:AddSlider({
			...
			max = 120,
			callback = function(State)
				if library.flags[GameTitle .. " Auto Mode"] then
					GunModules()
				end
			end
		})
		...
		RageCombat:AddToggle({
			...
			callback = function(State)
				if State then
					library:AddConnection(runService.RenderStepped, "Kill", function()
										...
										coroutine.resume(coroutine.create(function()
											if KillAuraMode == "Legit" then
												...
												if game:GetService("Players").LocalPlayer.Character:FindFirstChildOfClass("Tool").Name == "Fists" then
													game:GetService("ReplicatedStorage").Events["XMHH2.1"]:FireServer("\240\159\154\168", tick(), game:GetService("Players").LocalPlayer.Character:FindFirstChildOfClass("Tool"), "2389ZFX33", KillAuraValue, false, game:GetService("Players").LocalPlayer.Character["Right Arm"], ((KillAuraTargetPart == "Random" and ClosestHumanoidRootPart.Parent[ValidTargetParts[math.random(1, # ValidTargetParts)]]) or ClosestHumanoidRootPart.Parent[KillAuraTargetPart]), ClosestHumanoidRootPart.Parent, game:GetService("Players").LocalPlayer.Character["Right Arm"].Position, ((KillAuraTargetPart == "Random" and ClosestHumanoidRootPart.Parent[ValidTargetParts[math.random(1, # ValidTargetParts)]]) or ClosestHumanoidRootPart.Parent[KillAuraTargetPart]).Position)
												else
													repeat
														wait()
					...
					library.connections["Kill"]:Disconnect()
				end
			end
		}):AddList({
			values = {
		...
		RageCombat:AddToggle({
			...
			callback = function(State)
				if State then
					library:AddConnection(runService.RenderStepped, "Finish", function()
									...
									if ClosestHumanoidRootPart.Parent:FindFirstChild("Humanoid").Health < 15 and not ClosestHumanoidRootPart.Parent:FindFirstChildOfClass("ForceField") then
										...
										coroutine.resume(coroutine.create(function()
											if FinishAuraMode == "Legit" then
												...
												wait(0.5)
												game:GetService("ReplicatedStorage").Events["XMHH2.1"]:FireServer("\240\159\154\168", tick(), game:GetService("Players").LocalPlayer.Character:FindFirstChildOfClass("Tool"), "2389ZFX33", FinishAuraValue, false, game:GetService("Players").LocalPlayer.Character["Right Leg"], ((FinishAuraTargetPart == "Random" and ClosestHumanoidRootPart.Parent[ValidTargetParts[math.random(1, # ValidTargetParts)]]) or ClosestHumanoidRootPart.Parent[FinishAuraTargetPart]), ClosestHumanoidRootPart.Parent, game:GetService("Players").LocalPlayer.Character["Right Leg"].Position, ((FinishAuraTargetPart == "Random" and ClosestHumanoidRootPart.Parent[ValidTargetParts[math.random(1, # ValidTargetParts)]]) or ClosestHumanoidRootPart.Parent[FinishAuraTargetPart]).Position)
											else
												local FinishAuraValue = game:GetService("ReplicatedStorage").Events["XMHH.1"]:InvokeServer("\240\159\154\168", tick(), game:GetService("Players").LocalPlayer.Character:FindFirstChildOfClass("Tool"), "EXECQQ")
												wait(0.5)
												game:GetService("ReplicatedStorage").Events["XMHH2.1"]:FireServer("\240\159\154\168", tick(), game:GetService("Players").LocalPlayer.Character:FindFirstChildOfClass("Tool"), "2389ZFX33", FinishAuraValue, false, game:GetService("Players").LocalPlayer.Character["Right Leg"], ((FinishAuraTargetPart == "Random" and ClosestHumanoidRootPart.Parent[ValidTargetParts[math.random(1, # ValidTargetParts)]]) or ClosestHumanoidRootPart.Parent[FinishAuraTargetPart]), ClosestHumanoidRootPart.Parent, game:GetService("Players").LocalPlayer.Character["Right Leg"].Position, ((FinishAuraTargetPart == "Random" and ClosestHumanoidRootPart.Parent[ValidTargetParts[math.random(1, # ValidTargetParts)]]) or ClosestHumanoidRootPart.Parent[FinishAuraTargetPart]).Position)
										...
										if FinishAuraMode == "Legit" then
											wait(2.5)
											FinishAuraCoolDown = false
										elseif FinishAuraMode == "Rage" then
											wait(0.25)
											FinishAuraCoolDown = false
										end
									end
					...
					library.connections["Finish"]:Disconnect()
				end
			end
		}):AddList({
			values = {
		...
		RageMovement:AddToggle({
			...
			callback = function(State)
				if State then
					library:AddConnection(runService.RenderStepped, "Walk", function()
					...
					library.connections["Walk"]:Disconnect()
					local Char = Players[Client].Character
					Char = Char and FFCoC(Char, "Humanoid")
					if Char then
						Char.WalkSpeed = 16
		...
		RageMovement:AddToggle({
			...
			callback = function(State)
				if State then
					library:AddConnection(runService.Stepped, "Clip", function()
					...
					library.connections["Clip"]:Disconnect()
				end
			end
		})
		...
		RageMisc:AddToggle({
			...
			callback = function(State)
				if State then
					library:AddConnection(runService.RenderStepped, "Pick Scrap", function()
					...
					library.connections["Pick Scrap"]:Disconnect()
				end
			end
		}):AddSlider({
		...
		RageMisc:AddToggle({
			...
			callback = function(State)
				if State then
					library:AddConnection(runService.RenderStepped, "Pick Tool", function()
					...
					library.connections["Pick Tool"]:Disconnect()
				end
			end
		}):AddSlider({
		...
		RageMisc:AddToggle({
			...
			callback = function(State)
				if State then
					library:AddConnection(runService.RenderStepped, "Pick Cash", function()
					...
					library.connections["Pick Cash"]:Disconnect()
				end
			end
		}):AddSlider({
		...
		RageMisc:AddToggle({
			...
			callback = function(State)
				if State then
					library:AddConnection(runService.RenderStepped, "UnLock", function()
					...
					library.connections["UnLock"]:Disconnect()
				end
			end
		}):AddSlider({
		...
		RageMisc:AddToggle({
			...
			callback = function(State)
				if State then
					library:AddConnection(runService.RenderStepped, "Break Safe", function()
					...
					library.connections["Break Safe"]:Disconnect()
				end
			end
		}):AddSlider({
		...
		RageMisc:AddToggle({
			...
			callback = function(State)
				if State then
					library:AddConnection(runService.RenderStepped, "Break Register", function()
					...
					library.connections["Break Register"]:Disconnect()
				end
			end
		}):AddSlider({
		...
		RageMisc:AddToggle({
			...
			callback = function(State)
				if State then
					library:AddConnection(runService.RenderStepped, "RePair And ReFill", function()
						if library and library.flags[GameTitle .. " Auto RePair And ReFill"] then
							coroutine.resume(coroutine.create(function()
								if AutoRePairAndReFillType == "Near" then
					...
					library.connections["RePair And ReFill"]:Disconnect()
				end
			end
		}):AddList({
			values = {
		...
		RageMisc:AddToggle({
			...
			callback = function(State)
				if State then
					library:AddConnection(runService.RenderStepped, "Claim Allowance", function()
					...
					library.connections["Claim Allowance"]:Disconnect()
				end
			end
		}):AddList({
			values = {
			...
			callback = function(State)
				if State then
					coroutine.resume(coroutine.create(function()
						...
						getRoot(game:GetService("Players").LocalPlayer.Character).bambam.Force = Vector3.new(99999,99999*10,99999)
						getRoot(game:GetService("Players").LocalPlayer.Character).bambam.Location = getRoot(game:GetService("Players").LocalPlayer.Character).Position
						library:SendNotification(5, "Loaded Invisible Fling Successfully")
					end))
				else
					if FLYING then
						library:SendNotification(5, "Loading Character Please wait")
						game:GetService("ReplicatedStorage").Events.DeathRespawn:InvokeServer()
						wait(3)
						NOFLY()
						library:SendNotification(5, "Loaded Character Successfully")
					end
				end
			end,
		})
		...
		TeleportationSection:AddButton({
			text = "Teleport",
			callback = function()
				if library.flags.Teleportation == "Tower" then
					Teleport(Vector3.new(- 4507.15, 105.564, - 820.79))
				elseif library.flags.Teleportation == "Illegal Pizza" then
					Teleport(Vector3.new(- 4421.7, 5.19914, - 137.65))
				elseif library.flags.Teleportation == "?" then
					Teleport(Vector3.new(- 4287.86, - 94.1664, - 813.529))
				elseif library.flags.Teleportation == "Vibe-Check" then
					Teleport(Vector3.new(- 4776.74, - 201.265, - 935.866))
				elseif library.flags.Teleportation == "Cafe-Locker" then
					Teleport(Vector3.new(- 4670.06, 5.9992, - 257.101))
				elseif library.flags.Teleportation == "Hideout" then
					Teleport(Vector3.new(- 4696.15, 16.9688, - 948.164))
				elseif library.flags.Teleportation == "Thrift Store" then
					Teleport(Vector3.new(- 4660.08, 4.09864, - 152.484))
				elseif library.flags.Teleportation == "Gas Station" then
					Teleport(Vector3.new(- 4431.49, 4.02059, 193.073))
				elseif library.flags.Teleportation == "Factory" then
					Teleport(Vector3.new(- 4410.92, 5.59988, - 554.302))
				elseif library.flags.Teleportation == "Warehouse" then
					Teleport(Vector3.new(- 4628.37, 6.69952, - 562.563))
				elseif library.flags.Teleportation == "Subway" then
					Teleport(Vector3.new(- 4707.42, - 32.3007, - 699.182))
				elseif library.flags.Teleportation == "Junkyard" then
		...
		TeleportationSection:AddButton({
			text = "Fix Air Stuck",
			callback = function()
				for i, v in ipairs(game:GetService("Workspace").Map.Parts["M_Parts"]:GetDescendants()) do
					if v.Name == "Trampoline" then
						game:GetService("ReplicatedStorage").Events.__DFfDD:FireServer("Tt__h", math.huge, v)
					end
				end
			end,
		})
		...
		AutoFarmSection:AddToggle({
			...
			callback = function(State)
				SafeAutoFarm = State
				if State then
					library:AddConnection(runService.RenderStepped, "SafeAuto", function()
					...
					library.connections["SafeAuto"]:Disconnect()
				end
			end
		})
	...
	elseif GameTitle == "Combat Warriors" then
		...
		coroutine.resume(coroutine.create(function()
			...
			Old_call = hookmetamethod(game, "__namecall", function(self, ...)
				...
				local Method = getnamecallmethod()
				if Method == "GetPropertyChangedSignal" and tostring(self) == "Humanoid" then
					return wait(9e9)
				end
				return Old_call(self, unpack(Args))
			end)
		...
		RageMovement:AddToggle({
			...
			callback = function(State)
				if State then
					library:AddConnection(runService.RenderStepped, "Clip", function()
						if library and library.flags[GameTitle .. " No Clip"] then
							print("a")
							local Char = Players[Client].Character
							Char = Char and FFCoC(Char, "Humanoid")
		...
		MT.__namecall = newcclosure(function(self, ...)
			...
			if Method == "FireServer" and tostring(self) == "TakeFallDamage" or tostring(self) == "StartFallDamage" then
				if library and library.flags[GameTitle .. " Disable Fall Damage"] then
					return
				end
			end
